		...
		setMatrix: function(matrix, options) {
			...
			if (contain) {
				...
				if (contain === 'invert') {
                    ...
                    matrix[4] =
                        Math.max(
                            Math.min(matrix[4], (Math.abs(scale) * width - width) / 2),
                            (Math.abs(scale) * width - width) / 2 - Math.max(Math.abs(scale) * width - container.width, 0)
                        );
                    matrix[5] =
                        Math.max(
                            Math.min(matrix[5], (Math.abs(scale) * height - height) / 2),
                            (Math.abs(scale) * height - height) / 2 - Math.max(Math.abs(scale) * height - container.height, 0)
                        );
